...
export const ChatProvider = ({ children }) => {
  ...
  return (
    <ChatContext.Provider value={{ isChatOpen, openChat, closeChat, toggleChat, messages, newMessage, setNewMessage, sendMessage, sendCart, cartItems, getTotal, user, loading, unreadCount, messagesEndRef, chatRef }}>
      {children}
      {/* Кнопка чата */}
      <button
        onClick={toggleChat}
